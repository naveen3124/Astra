...
import com.astra.app.btree4j.utils.collections.longs.LongArrayList;
import com.astra.app.btree4j.utils.collections.longs.LongHash.LongLRUMap;
import com.astra.app.btree4j.utils.lang.Primitives;
import com.astra.app.btree4j.utils.lang.PrintUtils;
...
public final class BTreeIndexDup extends BTreeIndex {
    private static Logger logger = LoggerFactory.getLogger(BTreeIndexDup.class);
        ...
        public boolean indexInfo(Value key, long pointer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                try {
                    ...
                    logger.error(PrintUtils.prettyPrintStackTrace(e));
                    throw new IllegalStateException(e);
                }
