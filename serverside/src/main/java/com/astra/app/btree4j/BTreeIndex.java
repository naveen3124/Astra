...
import com.astra.app.btree4j.FreeList.FreeSpace;
import com.astra.app.btree4j.indexer.IndexQuery;
import com.astra.app.btree4j.utils.collections.LRUMap;
...
public class BTreeIndex extends BTree {
    ...
    static {
        DATA_CACHE_SIZE = Primitives.parseInt(Settings.get("com.astra.app.btree4j.bfile.datacache_size"), 2048); // 4k * 2048 = 8m
        DATA_CACHE_PURGE_UNIT =
                Primitives.parseInt(Settings.get("com.astra.app.btree4j.bfile.datacache_purgeunit"), 16); // 4k * 16 = 64k
    }
