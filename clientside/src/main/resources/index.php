				...
				<div class="myDiv" id ="form1div">
					<form id="form1" method = "post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
						...
						<div class="myDiv2">
							...
							<b class="p1">Location Type: </b> 
							<select name="loctype" id="loctype">
								<option class="p1" value="commerical">Commerical</option>
								<option class="p1" value="religious">Religious</option>
								<option class="p1" value="residential">Residential</option>
								<option class="p1" value="entertainment">Entertainment</option>
